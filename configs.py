...
class Config:
    ...
    CHANNEL_ID = list(set(int(x) for x in str(getenv("CHANNEL_ID", "-1001797626445 -1001816164988 -1001562195772 -1001928370532 -1001824185044 -1001674410044 -1001849017994 -1001832085294 -1001733199020 -1001347977016 -1001715180239 -1001890039607 -1001644078975")).split()))
